...
const Typography = React.forwardRef<HTMLElement, TypographyProps>(
  ({
    ...
    const variants = {
      h1: "text-[clamp(3.5rem,13vw,11rem)] leading-[0.9] tracking-tighter mb-4",
      ...
      span: "inline-block",
      small: "text-[0.6rem] uppercase tracking-[0.4em] font-bold text-accent-mint-base",
    };
    ...
    const resolvedFont = font || (["h1", "h2", "h3", "h4"].includes(variant) ? "display" : "body");
